...
#define TRST 10               // Start parameter windwos in secs
#define TRNS 40               // Sample windows time in millisecs
#define TASD 1000             // time after send data in secs
...
void setup()
{
  ...
  RSLref = 50000;
  IQRref = 50000;    // Interquiarlie value reference
  ZCref = 50000;     // each axis Zero crossing sum reference
  CAVref = 50000;    // Cumulative Acceleration vector reference
  ACNref = 50000;
  IQRmax = 0.0;
  IQRmin = 0.0;
  CAVmax = 0;
