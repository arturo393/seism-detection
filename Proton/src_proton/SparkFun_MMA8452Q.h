...
enum MMA8452Q_HP_BW {HP_4, HP_2, HP_1, HP_05}; // possible data rates for 100 Hz
...
public:
	...
	byte init(MMA8452Q_Scale fsr = SCALE_2G, MMA8452Q_ODR odr = ODR_800, MMA8452Q_HP_BW = HP_4);
	byte setup();
	void readRaw();
	void read();
	byte available();
...
private:
	...
	void setHPFilter(MMA8452Q_HP_BW bw);
